...
if (length(args) < 7) {
  stop("Rscipt Lnc-Upset.R CPAT_list CPC2_list RNAsamba_list FEELnc_list lgc_list pfamscan_list lncfinder_list")
}
...
tiff("LncRAnalyzer-summary/LncRAnalyzer-Lncs-UpSet.tiff", units="cm", width = 22.5,
     height = 15, res = 300)
upset(binary_matrix, 
      sets = names(data1), 
