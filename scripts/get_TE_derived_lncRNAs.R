...
if (length(args) < 8) {
  stop("Rscript get_TE_derived_lncRNAs.R LTR_file LINE_file SINE_file MITE_file TIR_file Helitron_file TE_derived_lnRNAs TE_derived_summary")
}
...
tiff("LncRAnalyzer-summary/TE-derived-lncRNAs.tiff", units="cm", width = 15,
     height=10, res=300)
